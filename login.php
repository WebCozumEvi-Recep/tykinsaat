...
require_once __DIR__ . '/inc/site.php'; require_once __DIR__ . '/inc/guvenlik.php';
...
?><!DOCTYPE html><html lang="tr"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Giriş · <?= APP_NAME ?></title><link rel="stylesheet" href="<?= e(varlik('assets/app.css')) ?>"></head>
